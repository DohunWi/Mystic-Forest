...
📹 Game Play Video - [[youtube]](https://www.youtube.com/watch?v=t2p8x0J4XqU)

📝 Project Overview
Mystic Forest는 숲을 오염시키는 거대 몬스터를 처치하는 2D 횡스크롤 액션 게임입니다.
...
Parry System: 적의 공격 타이밍에 맞춰 방어 시 Time.timeScale을 조절하여 슬로우 모션 효과와 반격 기회 제공.
...
Screen Shake: Cinemachine Impulse Source를 활용한 동적 카메라 흔들림.
...
📂 Installation
이 프로젝트는 Unity 6.3 LTS(6000.3.2f1) 버전으로 제작되었습니다.

Clone the repository:

Bash
git clone https://github.com/DohunWi/Mystic-Forest.git
Open in Unity Hub (Select the project folder).

Open Scenes/TitleScene to start.
...
Contact: widohun7@gmail.com

Blog/DevLog: https://www.notion.so/Mystic-Forest-2D-2cdb8e281c728063a15de9c46b3adb43?pvs=12
